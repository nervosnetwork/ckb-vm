  ...
  //| postcall
  //| ret
  dasm_put(Dst, 283, CKB_VM_ASM_MEMORY_FRAME_SHIFTS, Dt1(->memory), CKB_VM_ASM_MEMORY_FRAMESIZE, (unsigned int)((uint64_t)memset), (unsigned int)(((uint64_t)memset)>>32));
#line 437 "src/machine/aot/aot.x64.c"
  ...
  //| pop r12
  //| ret
  dasm_put(Dst, 345, Dt1(->registers[REGISTER_RA]), Dt1(->registers[REGISTER_SP]), Dt1(->registers[REGISTER_A0]));
...
int aot_add(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 373, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 381, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 389, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 397, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 516 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 406, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 419, (loc1));
        } else {
      dasm_put(Dst, 401, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 425, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 432, Dt1(->registers[target]), b.value.i);
        }
      }
#line 519 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 373, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 389, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_sub(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 438, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 446, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 454, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 462, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 547 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 406, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 471, (loc1));
        } else {
      dasm_put(Dst, 466, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 477, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 484, Dt1(->registers[target]), b.value.i);
        }
      }
#line 550 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 438, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 454, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_mul(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 490, (loc1));
      } else {
      dasm_put(Dst, 497, Dt1(->registers[b.value.reg]));
      }
#line 571 "src/machine/aot/aot.x64.c"
      break;
    case AOT_TAG_IMMEDIATE:
      //| load_imm rcx, b.value.i
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 503, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 516, b.value.i);
      }
...
#line 575 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 490, (b.value.x64_reg));
#line 578 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 526, (loc1));
  } else {
  dasm_put(Dst, 532, Dt1(->registers[target]));
  }
...
#line 599 "src/machine/aot/aot.x64.c"
        ...
        loc1 = riscv_reg_to_x64_reg(b.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
        dasm_put(Dst, 550, (loc1));
        } else {
        dasm_put(Dst, 557, Dt1(->registers[b.value.reg]));
        }
...
#line 614 "src/machine/aot/aot.x64.c"
        ...
        dasm_put(Dst, 550, (b.value.x64_reg));
...
#line 662 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 608, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 621, b.value.i);
      }
...
int aot_div(AotContext* context, riscv_register_t target, AotValue a, AotValue b, int is_signed)
{
  ...
  if (is_signed) {
    //| mov64 rax, INT64_MIN
    dasm_put(Dst, 659, (unsigned int)(INT64_MIN), (unsigned int)((INT64_MIN)>>32));
...
#line 721 "src/machine/aot/aot.x64.c"
  ...
  if ((uint64_t)UINT64_MAX > 0xFFFFFFFF && (((uint64_t)UINT64_MAX & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
    loc1 = riscv_reg_to_x64_reg(target);
  dasm_put(Dst, 406, (uint64_t)UINT64_MAX >> 32, (uint64_t)UINT64_MAX & 0xFFFFFFFF);
    if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 526, (loc1));
    } else {
  dasm_put(Dst, 532, Dt1(->registers[target]));
    ...
    loc1 = riscv_reg_to_x64_reg(target);
    if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 714, (loc1), (uint64_t)UINT64_MAX);
    } else {
  dasm_put(Dst, 721, Dt1(->registers[target]), (uint64_t)UINT64_MAX);
    }
  }
...
#line 735 "src/machine/aot/aot.x64.c"
        ...
        loc1 = riscv_reg_to_x64_reg(b.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
        dasm_put(Dst, 755, (loc1));
        } else {
        dasm_put(Dst, 763, Dt1(->registers[b.value.reg]));
        }
...
#line 748 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      if (is_signed) {
        ...
        dasm_put(Dst, 786, (b.value.x64_reg));
#line 754 "src/machine/aot/aot.x64.c"
      } else {
        //| xor rdx, rdx
        //| div Rq(b.value.x64_reg)
        dasm_put(Dst, 796, (b.value.x64_reg));
...
#line 779 "src/machine/aot/aot.x64.c"
    ...
    if ((uint64_t)0 > 0xFFFFFFFF && (((uint64_t)0 & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      loc1 = riscv_reg_to_x64_reg(target);
    dasm_put(Dst, 406, (uint64_t)0 >> 32, (uint64_t)0 & 0xFFFFFFFF);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 526, (loc1));
      } else {
    dasm_put(Dst, 532, Dt1(->registers[target]));
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 714, (loc1), (uint64_t)0);
      } else {
    dasm_put(Dst, 721, Dt1(->registers[target]), (uint64_t)0);
      }
    }
...
int aot_and(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 810, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 818, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 826, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 834, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 853 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 406, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 843, (loc1));
        } else {
      dasm_put(Dst, 838, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 849, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 856, Dt1(->registers[target]), b.value.i);
        }
      }
#line 856 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 810, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 826, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_or(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 862, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 870, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 878, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 886, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 884 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 890, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 901, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 908, Dt1(->registers[target]), b.value.i);
        }
      }
#line 887 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 862, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 878, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_not(AotContext* context, riscv_register_t target, AotValue a, int logical)
{
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 914, (loc1));
  } else {
  dasm_put(Dst, 921, Dt1(->registers[target]));
  }
#line 906 "src/machine/aot/aot.x64.c"
  if (logical) {
    ...
    if ((uint64_t)1 > 0xFFFFFFFF && (((uint64_t)1 & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      loc1 = riscv_reg_to_x64_reg(target);
    dasm_put(Dst, 406, (uint64_t)1 >> 32, (uint64_t)1 & 0xFFFFFFFF);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 843, (loc1));
      } else {
    dasm_put(Dst, 838, Dt1(->registers[target]));
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 849, (loc1), (uint64_t)1);
      } else {
    dasm_put(Dst, 856, Dt1(->registers[target]), (uint64_t)1);
      }
    }
#line 908 "src/machine/aot/aot.x64.c"
  }
...
int aot_xor(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 927, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 935, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 943, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 951, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 932 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 406, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 960, (loc1));
        } else {
      dasm_put(Dst, 955, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 966, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 974, Dt1(->registers[target]), b.value.i);
        }
      }
#line 935 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 927, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 943, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_shl(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 986, Dt1(->registers[b.value.reg]));
      }
...
#line 996 "src/machine/aot/aot.x64.c"
  ...
  if (is_signed) {
    ...
    dasm_put(Dst, 1012, Dt1(->registers[target]));
    }
...
int aot_eq(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 1034, Dt1(->registers[b.value.reg]));
      }
...
int aot_cond(AotContext* context, riscv_register_t target, AotValue condition, AotValue true_value, AotValue false_value) {
  ...
  switch (condition.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 1081, Dt1(->registers[condition.value.reg]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(condition.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1086, (loc1), (uint64_t)1);
        } else {
      dasm_put(Dst, 1094, Dt1(->registers[condition.value.reg]), (uint64_t)1);
        }
      }
...
#line 1086 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| jne >1
      dasm_put(Dst, 1107, (condition.value.x64_reg));
...
#line 1148 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      if (bits.value.i < 64) {
        ...
        dasm_put(Dst, 1151, (64 - bits.value.i));
#line 1153 "src/machine/aot/aot.x64.c"
        if (is_signed) {
          //| sar rax, (64 - bits.value.i)
          dasm_put(Dst, 1156, (64 - bits.value.i));
...
#line 1157 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| shl rax, cl
      //| mov ecx, edx
      dasm_put(Dst, 1167, (bits.value.x64_reg));
...
int aot_add_cycles(AotContext* context, uint64_t cycles)
{
  ...
  dasm_put(Dst, 406, cycles >> 32, cycles & 0xFFFFFFFF);
  } else {
  dasm_put(Dst, 1039, cycles);
  }
#line 1196 "src/machine/aot/aot.x64.c"
  ...
  //| jna >1
  dasm_put(Dst, 1197, Dt1(->cycles), Dt1(->max_cycles), Dt1(->cycles));
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      switch ((uint8_t) (value.value.i >> 56)) {
        case 0x80:
          ...
          dasm_put(Dst, 503, (value.value.i & 0xFFFFFFFFFFFFFF) >> 32, (value.value.i & 0xFFFFFFFFFFFFFF) & 0xFFFFFFFF);
          } else {
          dasm_put(Dst, 516, (value.value.i & 0xFFFFFFFFFFFFFF));
          }
...
#line 1252 "src/machine/aot/aot.x64.c"
        ...
        case 0x40:
          ...
          dasm_put(Dst, 1214, Dt1(->pc), ((uint32_t)(value.value.i & 0x7FFFFFFF)), ((value.value.i >> 32) ^ 0x40000000));
#line 1256 "src/machine/aot/aot.x64.c"
        ...
        case 0x0:
          ...
          dasm_put(Dst, 503, value.value.i >> 32, value.value.i & 0xFFFFFFFF);
          } else {
          dasm_put(Dst, 516, value.value.i);
          }
...
#line 1260 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1223, (value.value.x64_reg), Dt1(->pc));
...
int aot_memory_write(AotContext* context, AotValue address, AotValue v, uint32_t size)
{
  ...
  dasm_put(Dst, 1231, size, Dt1(->memory));
#line 1325 "src/machine/aot/aot.x64.c"
...
static int aot_mov_internal(AotContext* context, riscv_register_t target, AotValue value, x64_register_t x64_temp_reg)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1356, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1364, (loc1), Dt1(->registers[value.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1223, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1372, (x64_temp_reg), Dt1(->registers[value.value.reg]), (x64_temp_reg), Dt1(->registers[target]));
      }
#line 1407 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (value.value.i > 0xFFFFFFFF && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 1387, (x64_temp_reg), value.value.i >> 32, (x64_temp_reg), (x64_temp_reg), value.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1356, (x64_temp_reg), (loc1));
        } else {
      dasm_put(Dst, 1223, (x64_temp_reg), Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 714, (loc1), value.value.i);
        } else {
      dasm_put(Dst, 721, Dt1(->registers[target]), value.value.i);
        }
      }
#line 1410 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1356, (value.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1223, (value.value.x64_reg), Dt1(->registers[target]));
      }
...
static int aot_mov_x64(AotContext* context, x64_register_t x64_target, AotValue value)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1356, (loc1), (x64_target));
      } else {
      dasm_put(Dst, 1364, (x64_target), Dt1(->registers[value.value.reg]));
      }
#line 1426 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (value.value.i > 0xFFFFFFFF && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 1387, (x64_target), value.value.i >> 32, (x64_target), (x64_target), value.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 714, (x64_target), value.value.i);
      }
#line 1429 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1356, (value.value.x64_reg), (x64_target));
