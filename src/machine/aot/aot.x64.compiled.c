"src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 356, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 372, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_sub(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 421, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 429, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 437, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 445, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 548 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 389, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 454, (loc1));
        } else {
      dasm_put(Dst, 449, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 460, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 467, Dt1(->registers[target]), b.value.i);
        }
      }
#line 551 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 421, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 437, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_mul(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 480, Dt1(->registers[b.value.reg]));
      }
#line 572 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 486, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 499, b.value.i);
      }
...
#line 579 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 509, (loc1));
  } else {
  dasm_put(Dst, 515, Dt1(->registers[target]));
  }
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      if (is_signed) {
        ...
        loc1 = riscv_reg_to_x64_reg(b.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
        dasm_put(Dst, 520, (loc1));
        } else {
        dasm_put(Dst, 527, Dt1(->registers[b.value.reg]));
        }
...
#line 610 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      if (is_signed) {
        ...
        dasm_put(Dst, 520, (b.value.x64_reg));
...
#line 617 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 557, (loc1));
  } else {
  dasm_put(Dst, 563, Dt1(->registers[target]));
  }
...
#line 663 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 591, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 604, b.value.i);
      }
...
int aot_div(AotContext* context, riscv_register_t target, AotValue a, AotValue b, int is_signed)
{
  ...
  if (is_signed) {
    //| mov64 rax, INT64_MIN
    dasm_put(Dst, 642, (unsigned int)(INT64_MIN), (unsigned int)((INT64_MIN)>>32));
...
#line 722 "src/machine/aot/aot.x64.c"
  ...
  if ((uint64_t)UINT64_MAX > 0xFFFFFFFF && (((uint64_t)UINT64_MAX & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
    loc1 = riscv_reg_to_x64_reg(target);
  dasm_put(Dst, 389, (uint64_t)UINT64_MAX >> 32, (uint64_t)UINT64_MAX & 0xFFFFFFFF);
    if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 509, (loc1));
    } else {
  dasm_put(Dst, 515, Dt1(->registers[target]));
    ...
    loc1 = riscv_reg_to_x64_reg(target);
    if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 697, (loc1), (uint64_t)UINT64_MAX);
    } else {
  dasm_put(Dst, 704, Dt1(->registers[target]), (uint64_t)UINT64_MAX);
    }
  }
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      if (is_signed) {
        ...
        dasm_put(Dst, 728, Dt1(->registers[b.value.reg]));
        }
#line 736 "src/machine/aot/aot.x64.c"
        ...
        dasm_put(Dst, 746, Dt1(->registers[b.value.reg]));
        }
...
#line 749 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      if (is_signed) {
        ...
        dasm_put(Dst, 769, (b.value.x64_reg));
...
#line 780 "src/machine/aot/aot.x64.c"
    ...
    if ((uint64_t)0 > 0xFFFFFFFF && (((uint64_t)0 & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      loc1 = riscv_reg_to_x64_reg(target);
    dasm_put(Dst, 389, (uint64_t)0 >> 32, (uint64_t)0 & 0xFFFFFFFF);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 509, (loc1));
      } else {
    dasm_put(Dst, 515, Dt1(->registers[target]));
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 697, (loc1), (uint64_t)0);
      } else {
    dasm_put(Dst, 704, Dt1(->registers[target]), (uint64_t)0);
      }
    }
...
int aot_and(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 793, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 801, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 809, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 817, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 854 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 389, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 826, (loc1));
        } else {
      dasm_put(Dst, 821, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 832, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 839, Dt1(->registers[target]), b.value.i);
        }
      }
#line 857 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 793, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 809, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_or(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 845, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 853, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 861, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 869, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 885 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 389, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 878, (loc1));
        } else {
      dasm_put(Dst, 873, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 884, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 891, Dt1(->registers[target]), b.value.i);
        }
      }
#line 888 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 845, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 861, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_not(AotContext* context, riscv_register_t target, AotValue a, int logical)
{
  ...
  dasm_put(Dst, 904, Dt1(->registers[target]));
  }
#line 907 "src/machine/aot/aot.x64.c"
  if (logical) {
    ...
    if ((uint64_t)1 > 0xFFFFFFFF && (((uint64_t)1 & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      loc1 = riscv_reg_to_x64_reg(target);
    dasm_put(Dst, 389, (uint64_t)1 >> 32, (uint64_t)1 & 0xFFFFFFFF);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 826, (loc1));
      } else {
    dasm_put(Dst, 821, Dt1(->registers[target]));
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 832, (loc1), (uint64_t)1);
      } else {
    dasm_put(Dst, 839, Dt1(->registers[target]), (uint64_t)1);
      }
    }
...
int aot_xor(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 910, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 918, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 926, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 934, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 933 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 389, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 943, (loc1));
        } else {
      dasm_put(Dst, 938, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 949, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 957, Dt1(->registers[target]), b.value.i);
        }
      }
#line 936 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 910, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 926, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
#line 967 "src/machine/aot/aot.x64.c"
  ...
  dasm_put(Dst, 983, Dt1(->registers[target]));
  }
...
#line 1002 "src/machine/aot/aot.x64.c"
    ...
    dasm_put(Dst, 1006, Dt1(->registers[target]));
    }
...
int aot_eq(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1011, (loc1));
      } else {
      dasm_put(Dst, 1017, Dt1(->registers[b.value.reg]));
      }
...
#line 1025 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1011, (b.value.x64_reg));
#line 1028 "src/machine/aot/aot.x64.c"
  ...
  dasm_put(Dst, 1045, Dt1(->registers[target]));
  }
...
int aot_cond(AotContext* context, riscv_register_t target, AotValue condition, AotValue true_value, AotValue false_value) {
  ...
  switch (condition.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 1064, Dt1(->registers[condition.value.reg]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(condition.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1069, (loc1), (uint64_t)1);
        } else {
      dasm_put(Dst, 1077, Dt1(->registers[condition.value.reg]), (uint64_t)1);
        }
      }
...
#line 1087 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| jne >1
      dasm_put(Dst, 1090, (condition.value.x64_reg));
...
#line 1149 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      if (bits.value.i < 64) {
        ...
        dasm_put(Dst, 1134, (64 - bits.value.i));
...
#line 1156 "src/machine/aot/aot.x64.c"
          ...
          dasm_put(Dst, 1145, (64 - bits.value.i));
#line 1158 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| shl rax, cl
      //| mov ecx, edx
      dasm_put(Dst, 1150, (bits.value.x64_reg));
...
int aot_add_cycles(AotContext* context, uint64_t cycles)
{
  ...
  dasm_put(Dst, 389, cycles >> 32, cycles & 0xFFFFFFFF);
  } else {
  dasm_put(Dst, 1022, cycles);
  }
#line 1197 "src/machine/aot/aot.x64.c"
  ...
  //| jna >1
  dasm_put(Dst, 1180, Dt1(->cycles), Dt1(->max_cycles), Dt1(->cycles));
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      switch ((uint8_t) (value.value.i >> 56)) {
        case 0x80:
          ...
          dasm_put(Dst, 486, (value.value.i & 0xFFFFFFFFFFFFFF) >> 32, (value.value.i & 0xFFFFFFFFFFFFFF) & 0xFFFFFFFF);
          } else {
          dasm_put(Dst, 499, (value.value.i & 0xFFFFFFFFFFFFFF));
          }
...
#line 1253 "src/machine/aot/aot.x64.c"
        ...
        case 0x40:
          ...
          dasm_put(Dst, 1197, Dt1(->pc), ((uint32_t)(value.value.i & 0x7FFFFFFF)), ((value.value.i >> 32) ^ 0x40000000));
#line 1257 "src/machine/aot/aot.x64.c"
        ...
        case 0x0:
          ...
          dasm_put(Dst, 486, value.value.i >> 32, value.value.i & 0xFFFFFFFF);
          } else {
          dasm_put(Dst, 499, value.value.i);
          }
...
#line 1261 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1206, (value.value.x64_reg), Dt1(->pc));
...
int aot_memory_write(AotContext* context, AotValue address, AotValue v, uint32_t size)
{
  ...
  dasm_put(Dst, 1214, size, size, Dt1(->memory));
...
int aot_memory_read(AotContext* context, uint32_t target, AotValue address, uint32_t size)
{
  ...
  //| ja >1
  //| lea rdx, machine->memory
  dasm_put(Dst, 1281, size, size, CKB_VM_ASM_RISCV_MAX_MEMORY, Dt1(->memory));
...
static int aot_mov_internal(AotContext* context, riscv_register_t target, AotValue value, x64_register_t x64_temp_reg)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1341, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1349, (loc1), Dt1(->registers[value.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1206, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1357, (x64_temp_reg), Dt1(->registers[value.value.reg]), (x64_temp_reg), Dt1(->registers[target]));
      }
#line 1410 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (value.value.i > 0xFFFFFFFF && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 1372, (x64_temp_reg), value.value.i >> 32, (x64_temp_reg), (x64_temp_reg), value.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1341, (x64_temp_reg), (loc1));
        } else {
      dasm_put(Dst, 1206, (x64_temp_reg), Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 697, (loc1), value.value.i);
        } else {
      dasm_put(Dst, 704, Dt1(->registers[target]), value.value.i);
        }
      }
#line 1413 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1341, (value.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1206, (value.value.x64_reg), Dt1(->registers[target]));
      }
...
static int aot_mov_x64(AotContext* context, x64_register_t x64_target, AotValue value)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1341, (loc1), (x64_target));
      } else {
      dasm_put(Dst, 1349, (x64_target), Dt1(->registers[value.value.reg]));
      }
#line 1429 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (value.value.i > 0xFFFFFFFF && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 1372, (x64_target), value.value.i >> 32, (x64_target), (x64_target), value.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 697, (x64_target), value.value.i);
      }
#line 1432 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1341, (value.value.x64_reg), (x64_target));
