CKB_VM_ASM_RET_OUT_OF_BOUND, CKB_VM_ASM_RET_INVALID_PERMISSION);
#line 440 "src/machine/aot/aot.x64.c"
  ...
  //| mov byte [rsi+rcx], 1
  //| call_inited_memory
  dasm_put(Dst, 335, CKB_VM_ASM_MEMORY_FRAME_SHIFTS, CKB_VM_ASM_MEMORY_FRAMES, Dt1(->frames), (unsigned int)((uint64_t)inited_memory), (unsigned int)(((uint64_t)inited_memory)>>32), CKB_VM_ASM_MEMORY_FRAME_SHIFTS, CKB_VM_ASM_MEMORY_FRAMES, (unsigned int)((uint64_t)inited_memory), (unsigned int)(((uint64_t)inited_memory)>>32));
#line 471 "src/machine/aot/aot.x64.c"
  ...
  //| pop rsi
  //| ret
  dasm_put(Dst, 506, CKB_VM_ASM_RET_OUT_OF_BOUND);
#line 482 "src/machine/aot/aot.x64.c"
  ...
  //| pop r12
  //| ret
  dasm_put(Dst, 553, Dt1(->registers[REGISTER_RA]), Dt1(->registers[REGISTER_SP]), Dt1(->registers[REGISTER_A0]));
...
int aot_add(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 581, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 589, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 597, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 605, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 561 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 614, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      ...
      dasm_put(Dst, 609, Dt1(->registers[target]));
        ...
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 633, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 640, Dt1(->registers[target]), b.value.i);
        }
      }
#line 564 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 581, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 597, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_sub(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 646, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 654, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 662, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 670, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 592 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 674, Dt1(->registers[target]));
        ...
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 685, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 692, Dt1(->registers[target]), b.value.i);
        }
      }
#line 595 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 646, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 662, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_mul(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 705, Dt1(->registers[b.value.reg]));
      }
#line 616 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 711, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 724, b.value.i);
      }
...
#line 620 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 698, (b.value.x64_reg));
#line 623 "src/machine/aot/aot.x64.c"
  ...
  dasm_put(Dst, 740, Dt1(->registers[target]));
  }
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      if (is_signed) {
        ...
        loc1 = riscv_reg_to_x64_reg(b.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
        dasm_put(Dst, 745, (loc1));
        } else {
        dasm_put(Dst, 752, Dt1(->registers[b.value.reg]));
        }
#line 644 "src/machine/aot/aot.x64.c"
        ...
        loc1 = riscv_reg_to_x64_reg(b.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
        dasm_put(Dst, 758, (loc1));
        } else {
        dasm_put(Dst, 765, Dt1(->registers[b.value.reg]));
        }
...
#line 654 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      if (is_signed) {
        ...
        dasm_put(Dst, 745, (b.value.x64_reg));
#line 659 "src/machine/aot/aot.x64.c"
      } else {
        //| mul Rq(b.value.x64_reg)
        dasm_put(Dst, 758, (b.value.x64_reg));
#line 661 "src/machine/aot/aot.x64.c"
  ...
  dasm_put(Dst, 788, Dt1(->registers[target]));
  }
...
#line 707 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (b.value.i > 0xFFFFFFFF && ((b.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 816, b.value.i >> 32, b.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 829, b.value.i);
      }
...
int aot_div(AotContext* context, riscv_register_t target, AotValue a, AotValue b, int is_signed)
{
  ...
  if (is_signed) {
    //| mov64 rax, INT64_MIN
    dasm_put(Dst, 501, (unsigned int)(INT64_MIN), (unsigned int)((INT64_MIN)>>32));
...
#line 766 "src/machine/aot/aot.x64.c"
  ...
  if ((uint64_t)UINT64_MAX > 0xFFFFFFFF && (((uint64_t)UINT64_MAX & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
    loc1 = riscv_reg_to_x64_reg(target);
  dasm_put(Dst, 614, (uint64_t)UINT64_MAX >> 32, (uint64_t)UINT64_MAX & 0xFFFFFFFF);
    if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 734, (loc1));
    } else {
  dasm_put(Dst, 740, Dt1(->registers[target]));
    ...
    loc1 = riscv_reg_to_x64_reg(target);
    if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 914, (loc1), (uint64_t)UINT64_MAX);
    } else {
  dasm_put(Dst, 921, Dt1(->registers[target]), (uint64_t)UINT64_MAX);
    }
  }
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      if (is_signed) {
        ...
        loc1 = riscv_reg_to_x64_reg(b.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
        dasm_put(Dst, 937, (loc1));
        } else {
        dasm_put(Dst, 945, Dt1(->registers[b.value.reg]));
        }
#line 780 "src/machine/aot/aot.x64.c"
        ...
        dasm_put(Dst, 963, Dt1(->registers[b.value.reg]));
        }
...
#line 793 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      if (is_signed) {
        ...
        dasm_put(Dst, 986, (b.value.x64_reg));
#line 799 "src/machine/aot/aot.x64.c"
      } else {
        //| xor rdx, rdx
        //| div Rq(b.value.x64_reg)
        dasm_put(Dst, 996, (b.value.x64_reg));
...
#line 824 "src/machine/aot/aot.x64.c"
    ...
    if ((uint64_t)0 > 0xFFFFFFFF && (((uint64_t)0 & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      loc1 = riscv_reg_to_x64_reg(target);
    dasm_put(Dst, 614, (uint64_t)0 >> 32, (uint64_t)0 & 0xFFFFFFFF);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 734, (loc1));
      } else {
    dasm_put(Dst, 740, Dt1(->registers[target]));
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 914, (loc1), (uint64_t)0);
      } else {
    dasm_put(Dst, 921, Dt1(->registers[target]), (uint64_t)0);
      }
    }
...
int aot_and(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1010, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1018, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1026, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1034, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 898 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 1038, Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1049, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 1056, Dt1(->registers[target]), b.value.i);
        }
      }
#line 901 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1010, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1026, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_or(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1062, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1070, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1078, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1086, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 929 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 1090, Dt1(->registers[target]));
        ...
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1101, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 1108, Dt1(->registers[target]), b.value.i);
        }
      }
#line 932 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1062, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1078, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_not(AotContext* context, riscv_register_t target, AotValue a, int logical)
{
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 1114, (loc1));
  } else {
  dasm_put(Dst, 1121, Dt1(->registers[target]));
  }
#line 951 "src/machine/aot/aot.x64.c"
  if (logical) {
    ...
    if ((uint64_t)1 > 0xFFFFFFFF && (((uint64_t)1 & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      loc1 = riscv_reg_to_x64_reg(target);
    dasm_put(Dst, 614, (uint64_t)1 >> 32, (uint64_t)1 & 0xFFFFFFFF);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 1043, (loc1));
      } else {
    dasm_put(Dst, 1038, Dt1(->registers[target]));
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
    dasm_put(Dst, 1049, (loc1), (uint64_t)1);
      } else {
    dasm_put(Dst, 1056, Dt1(->registers[target]), (uint64_t)1);
      }
    }
...
int aot_xor(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc2 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1127, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1135, (loc1), Dt1(->registers[b.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1143, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1151, Dt1(->registers[b.value.reg]), Dt1(->registers[target]));
      }
#line 977 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      dasm_put(Dst, 1155, Dt1(->registers[target]));
        ...
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1166, (loc1), b.value.i);
        } else {
      dasm_put(Dst, 1174, Dt1(->registers[target]), b.value.i);
        }
      }
#line 980 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1127, (b.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1143, (b.value.x64_reg), Dt1(->registers[target]));
      }
...
int aot_shl(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 1186, Dt1(->registers[b.value.reg]));
      }
...
#line 1011 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 1194, (loc1));
  } else {
  dasm_put(Dst, 1200, Dt1(->registers[target]));
  }
...
#line 1041 "src/machine/aot/aot.x64.c"
  ...
  if (is_signed) {
    ...
    dasm_put(Dst, 1212, Dt1(->registers[target]));
    }
...
int aot_eq(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 1234, Dt1(->registers[b.value.reg]));
      }
...
#line 1069 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1228, (b.value.x64_reg));
#line 1072 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 1256, (loc1));
  } else {
  dasm_put(Dst, 1262, Dt1(->registers[target]));
  }
...
int aot_cond(AotContext* context, riscv_register_t target, AotValue condition, AotValue true_value, AotValue false_value) {
  ...
  switch (condition.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 614, (uint64_t)1 >> 32, (uint64_t)1 & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1275, (loc1));
        } else {
      dasm_put(Dst, 1281, Dt1(->registers[condition.value.reg]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(condition.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1286, (loc1), (uint64_t)1);
        } else {
      dasm_put(Dst, 1294, Dt1(->registers[condition.value.reg]), (uint64_t)1);
        }
      }
...
#line 1131 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| jne >1
      dasm_put(Dst, 1307, (condition.value.x64_reg));
...
#line 1202 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| shl rax, cl
      //| mov ecx, edx
      dasm_put(Dst, 1367, (bits.value.x64_reg));
...
int aot_add_cycles(AotContext* context, uint64_t cycles)
{
  ...
  dasm_put(Dst, 614, cycles >> 32, cycles & 0xFFFFFFFF);
  } else {
  dasm_put(Dst, 1239, cycles);
  }
#line 1241 "src/machine/aot/aot.x64.c"
  //| add rax, machine->cycles
  //| cmp rax, machine->max_cycles
  //| jna >1
  dasm_put(Dst, 1397, Dt1(->cycles), Dt1(->max_cycles));
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      switch ((uint8_t) (value.value.i >> 56)) {
        case 0x80:
          ...
          dasm_put(Dst, 711, (value.value.i & 0xFFFFFFFFFFFFFF) >> 32, (value.value.i & 0xFFFFFFFFFFFFFF) & 0xFFFFFFFF);
          } else {
          dasm_put(Dst, 724, (value.value.i & 0xFFFFFFFFFFFFFF));
          }
...
#line 1303 "src/machine/aot/aot.x64.c"
        ...
        case 0x40:
          ...
          dasm_put(Dst, 1417, Dt1(->pc), ((uint32_t)(value.value.i & 0x7FFFFFFF)), ((value.value.i >> 32) ^ 0x40000000));
#line 1307 "src/machine/aot/aot.x64.c"
        ...
        case 0x0:
          ...
          dasm_put(Dst, 711, value.value.i >> 32, value.value.i & 0xFFFFFFFF);
          } else {
          dasm_put(Dst, 724, value.value.i);
          }
...
#line 1311 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1426, (value.value.x64_reg), Dt1(->pc));
...
int aot_memory_write(AotContext* context, AotValue address, AotValue v, uint32_t size)
{
  ...
  dasm_put(Dst, 1434, size, Dt1(->memory));
...
int aot_memory_read(AotContext* context, uint32_t target, AotValue address, uint32_t size)
{
  ...
  dasm_put(Dst, 1485, size, size, CKB_VM_ASM_RISCV_MAX_MEMORY);
...
static int aot_mov_internal(AotContext* context, riscv_register_t target, AotValue value, x64_register_t x64_temp_reg)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1547, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1555, (loc1), Dt1(->registers[value.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1426, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1563, (x64_temp_reg), Dt1(->registers[value.value.reg]), (x64_temp_reg), Dt1(->registers[target]));
      }
#line 1460 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (value.value.i > 0xFFFFFFFF && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 1578, (x64_temp_reg), value.value.i >> 32, (x64_temp_reg), (x64_temp_reg), value.value.i & 0xFFFFFFFF);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1547, (x64_temp_reg), (loc1));
        } else {
      dasm_put(Dst, 1426, (x64_temp_reg), Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 914, (loc1), value.value.i);
        } else {
      dasm_put(Dst, 921, Dt1(->registers[target]), value.value.i);
        }
      }
#line 1463 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1547, (value.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1426, (value.value.x64_reg), Dt1(->registers[target]));
      }
...
static int aot_mov_x64(AotContext* context, x64_register_t x64_target, AotValue value)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1547, (loc1), (x64_target));
      } else {
      dasm_put(Dst, 1555, (x64_target), Dt1(->registers[value.value.reg]));
      }
#line 1479 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if (value.value.i > 0xFFFFFFFF && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 1578, (x64_target), value.value.i >> 32, (x64_target), (x64_target), value.value.i & 0xFFFFFFFF);
      } else {
      dasm_put(Dst, 914, (x64_target), value.value.i);
      }
#line 1482 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1547, (value.value.x64_reg), (x64_target));
