...
pub fn factory<R: Register>(instruction_bits: u32, _: u32) -> Option<Instruction> {
    ...
    let inst = match opcode(instruction_bits) {
        0b_0000111 => {
            let inst_opt = match instruction_bits & 0b_000_111_0_11111_00000_111_00000_1111111 {
                0b_000_000_0_00000_00000_000_00000_0000111 => Some(insts::OP_VLE8_V),
                0b_000_000_0_00000_00000_101_00000_0000111 => Some(insts::OP_VLE16_V),
                0b_000_000_0_00000_00000_110_00000_0000111 => Some(insts::OP_VLE32_V),
                0b_000_000_0_00000_00000_111_00000_0000111 => Some(insts::OP_VLE64_V),
                0b_000_100_0_00000_00000_000_00000_0000111 => Some(insts::OP_VLE128_V),
                0b_000_100_0_00000_00000_101_00000_0000111 => Some(insts::OP_VLE256_V),
                0b_000_100_0_00000_00000_110_00000_0000111 => Some(insts::OP_VLE512_V),
                0b_000_100_0_00000_00000_111_00000_0000111 => Some(insts::OP_VLE1024_V),
                _ => None,
            };
            inst_opt.map(|inst| {
                Itype::new(
        ...
        0b_0100111 => {
            let inst_opt = match instruction_bits & 0b_000_111_0_11111_00000_111_00000_1111111 {
                0b_000_000_0_00000_00000_000_00000_0100111 => Some(insts::OP_VSE8_V),
                0b_000_000_0_00000_00000_101_00000_0100111 => Some(insts::OP_VSE16_V),
                0b_000_000_0_00000_00000_110_00000_0100111 => Some(insts::OP_VSE32_V),
                0b_000_000_0_00000_00000_111_00000_0100111 => Some(insts::OP_VSE64_V),
                0b_000_100_0_00000_00000_000_00000_0100111 => Some(insts::OP_VSE128_V),
                0b_000_100_0_00000_00000_101_00000_0100111 => Some(insts::OP_VSE256_V),
                0b_000_100_0_00000_00000_110_00000_0100111 => Some(insts::OP_VSE512_V),
                0b_000_100_0_00000_00000_111_00000_0100111 => Some(insts::OP_VSE1024_V),
                _ => None,
            };
            inst_opt.map(|inst| {
                Itype::new(
